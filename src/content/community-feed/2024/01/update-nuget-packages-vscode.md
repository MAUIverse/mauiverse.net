---
title: ".NET MAUI: Update NuGet Packages using Visual Studio Code"
...
[Check out Victor's guide](https://dev.to/vhugogarcia/net-maui-update-nuget-packages-using-visual-studio-code-32al) and keep your packages fresh!
