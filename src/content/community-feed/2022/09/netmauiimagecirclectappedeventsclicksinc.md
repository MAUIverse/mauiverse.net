---
title: ".NET MAUI Image Circle C# Tapped Events Clicks (C#)"
link: https://www.youtube.com/watch?v=sq4k3MQPOV8
description: ".NET MAUI Image Circle C# Tapped Events Clicks (C#) walks through a practical way to implement a working baseline you can adapt in your app in .NET MAUI. You will learn why implementing a practical .NET MAUI feature quickly matters and how to wire the feature from setup to a working result."
date: 2022-09-19
